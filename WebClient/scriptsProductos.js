document.addEventListener('DOMContentLoaded', () => {
    ...
    let products = [{
            ...
            ingredients: "Harina, Queso, Tomate, Albahaca"
        },
        {
            id: 2,
            name: "Hamburguesa",
            description: "Carne de vacuno, queso, lechuga y tomate",
            price: 9.00,
            allergens: "Gluten, Lactosa",
            ingredients: "Pan, Carne de vacuno, Queso, Lechuga, Tomate"
        },
        {
            id: 3,
            name: "Ensalada César",
            description: "Pollo, lechuga, crutones y aderezo César",
            price: 7.00,
            allergens: "Gluten, Huevo",
            ingredients: "Pollo, Lechuga, Crutones, Aderezo César"
        }
    ];
    ...
    function openProductModal(index) {
        ...
        document.getElementById('productForm').onsubmit = function(event) {
            ...
            product.image = document.getElementById('productImage').files[0]; // Guardar la imagen
    ...
    function toggleEditMode(editable) {
        ...
        document.getElementById('productImage').style.display = editable ? 'block' : 'none';
        document.getElementById('uploadButton').style.display = editable ? 'inline-block' : 'none';
    ...
    // Evento para mostrar vista previa de la imagen cargada
    ...
    // Asegurarse de que el botón de editar funcione correctamente
